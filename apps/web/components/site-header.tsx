...
export function SiteHeader() {
 ...
 <div className="container nav"><a className="brand" href="#top" aria-label="Apogix home"><Image className="brand-logo" src="/apogix-logo.webp" alt="Apogix" width={139} height={40} priority/></a>
